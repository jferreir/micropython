 ...
 *
 * This is an example depicting usage of the ADC driver to enable the external MUX.
 * Any conversion triggered on ADC_G0/channel1 will change the mux setting in sequence, 7,6,5,4,3,2,1,0, 7,6,5,...
...
int main(void)
{
  ...
  XMC_GPIO_SetMode(P2_10, (XMC_GPIO_MODE_t)((int32_t)XMC_GPIO_MODE_OUTPUT_PUSH_PULL | (int32_t)P2_10_AF_VADC_EMUX10));
  XMC_GPIO_SetMode(P2_14, (XMC_GPIO_MODE_t)((int32_t)XMC_GPIO_MODE_OUTPUT_PUSH_PULL | (int32_t)P2_14_AF_VADC_EMUX11));
  XMC_GPIO_SetMode(P2_15, (XMC_GPIO_MODE_t)((int32_t)XMC_GPIO_MODE_OUTPUT_PUSH_PULL | (int32_t)P2_15_AF_VADC_EMUX12));
